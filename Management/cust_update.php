...
<H1>학생 정보 수정</H1>
<FORM METHOD="post" ACTION="cust_update_result.php">
...
<input type="text" NAME="cust_name" class="form-control" placeholder="NAME" style="width:300px" style="height:100px" value=<?php echo $custName ?>><br>
<input type="text" NAME="cust_age" class="form-control" placeholder="AGE" style="width:300px" style="height:100px" value=<?php echo $custAge ?>><br><BR>
